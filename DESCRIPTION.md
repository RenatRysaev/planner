...
3. Я как лид команды хочу иметь возможность добавлять фрагменты задачи, чтобы помнимать:

- кто несет ответственность за каждый фрагмент задачи
- с какое по какое число планируется сделать фрагмент задачи
- какая активность(пример: фронтенд, бекенд, тестирование) планируется в этот фрагмент задачи

4. Я как лид команды хочу иметь возможность удалять/изменять фрагмент задачи, чтобы поддерживать фрагменты в актуальном состоянии
